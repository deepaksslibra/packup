...
export const PACKING_MASTER_LIST: PackingCategory[] = [
  {
    ...
    items: [
      // Tops
      { name: 'T-Shirts', icon: 'TShirt', essential: true, defaultQuantity: 5, estimatedWeight: 150 }, // [2, 6, 10]
      { name: 'Dress Shirts', icon: 'UserTie', tags: ['business', 'formal'], estimatedWeight: 250 }, // [1]
      { name: 'Blouses', icon: 'PersonSimple', tags: ['business', 'formal', 'women'], estimatedWeight: 180 },
      { name: 'Casual Shirts', icon: 'ShirtFolded', defaultQuantity: 3, estimatedWeight: 200 },
      { name: 'Casual Tops', icon: 'TShirt', defaultQuantity: 2, tags: ['casual', 'women'], estimatedWeight: 150 },
      { name: 'Polo Shirts', icon: 'TShirt', tags: ['business_casual', 'casual', 'men'], estimatedWeight: 220 },
      { name: 'Tank Tops', icon: 'TShirt', tags: ['summer', 'gym', 'layering'], estimatedWeight: 100 }, // [5]
      { name: 'Camisoles', icon: 'TShirt', tags: ['layering', 'women'], estimatedWeight: 80 },
      { name: 'Crop Tops', icon: 'TShirt', tags: ['women', 'casual', 'summer'], estimatedWeight: 90 },
      { name: 'Sweaters', icon: 'TShirt', tags: ['cold', 'layering', 'winter'], estimatedWeight: 350 }, // [1]
      { name: 'Hoodies', icon: 'Hoodie', tags: ['casual', 'comfort'], estimatedWeight: 500 }, // [1, 27]
      { name: 'Turtleneck Sweater', icon: 'TShirt', tags: ['winter', 'cold'], estimatedWeight: 380 },
      { name: 'Cardigan', icon: 'TShirt', tags: ['layering', 'casual'], estimatedWeight: 300 },
      { name: 'Fleece Jacket', icon: 'CoatHanger', tags: ['outdoor', 'warmth', 'layering'], estimatedWeight: 400 }, // [16]
      { name: 'Jumper', icon: 'TShirt', tags: ['casual', 'warmth'], estimatedWeight: 350 }, // UK term for sweater/pullover [1]
      { name: 'Fashion Vests', icon: 'CoatHanger', tags: ['layering', 'fashion'], estimatedWeight: 250 },
      { name: 'Outerwear Vests', icon: 'CoatHanger', tags: ['layering', 'outdoor', 'warmth'], estimatedWeight: 350 },
      ...
      { name: 'Skirts', icon: 'PersonSimple', tags: ['casual', 'formal', 'women'], estimatedWeight: 300 },
      { name: 'Capri Pants', icon: 'Pants', tags: ['casual', 'women'], estimatedWeight: 300 },
      { name: 'Leggings', icon: 'Pants', tags: ['casual', 'active', 'women', 'comfort'], estimatedWeight: 200 },
      { name: 'Workout Leggings', icon: 'Pants', tags: ['active', 'sports', 'gym', 'women'], estimatedWeight: 220 },
      { name: 'Workout Shorts', icon: 'Pants', tags: ['active', 'sports', 'gym'], estimatedWeight: 180 },
      { name: 'Sweatpants', icon: 'Pants', tags: ['casual', 'comfort', 'active', 'travel'], estimatedWeight: 400 }, // [11]
      { name: 'Joggers', icon: 'Pants', tags: ['casual', 'comfort', 'active', 'travel'], estimatedWeight: 380 },
      { name: 'Cargo Pants', icon: 'Pants', tags: ['outdoor', 'utility'], estimatedWeight: 550 },
      // Dresses & Jumpsuits
      { name: 'Casual Dresses', icon: 'PersonSimple', tags: ['women', 'summer', 'daily'], estimatedWeight: 350 },
      { name: 'Sundresses', icon: 'Sun', tags: ['beach', 'casual', 'women'], estimatedWeight: 250 },
      { name: 'Maxi Dresses', icon: 'PersonSimple', tags: ['beach', 'casual', 'women', 'evening'], estimatedWeight: 450 }, // [5]
      { name: 'Business Dresses', icon: 'Briefcase', tags: ['business', 'women', 'formal'], estimatedWeight: 400 },
      { name: 'Formal Dresses', icon: 'PersonSimple', tags: ['event', 'women', 'wedding'], estimatedWeight: 600 },
      { name: 'Gowns', icon: 'PersonSimple', tags: ['event', 'women', 'black_tie'], estimatedWeight: 1000 }, // Can be much heavier [29]
      { name: 'Rompers', icon: 'PersonSimple', tags: ['women', 'casual', 'summer'], estimatedWeight: 300 },
      { name: 'Jumpsuits', icon: 'PersonSimple', tags: ['women', 'casual', 'formal'], estimatedWeight: 500 },
      // Outerwear
      { name: 'Light Jacket', icon: 'CoatHanger', tags: ['spring', 'fall', 'layering'], estimatedWeight: 500 }, // [16]
      { name: 'Denim Jacket', icon: 'CoatHanger', tags: ['casual'], estimatedWeight: 700 }, // [3, 13]
      { name: 'Leather Jacket', icon: 'CoatHanger', tags: ['casual', 'fashion'], estimatedWeight: 1500 }, // [3, 7, 14, 15, 26]
      { name: 'Windbreaker', icon: 'Wind', tags: ['outdoor', 'sports', 'lightweight'], estimatedWeight: 250 }, // [1, 18, 19]
      ...
      { name: 'Rain Jacket', icon: 'CloudRain', essential: true, tags: ['rain', 'outdoor'], estimatedWeight: 350 }, // [16]
      { name: 'Waterproof Trousers', icon: 'Pants', tags: ['outdoor', 'rain', 'hiking'], estimatedWeight: 300 },
      { name: 'Rain Poncho', icon: 'UmbrellaSimple', tags: ['outdoor', 'rain', 'festival'], estimatedWeight: 200 },
      {
      ...
      { name: 'Insulated Jacket', icon: 'ThermometerHot', tags: ['outdoor', 'winter', 'cold'], estimatedWeight: 800 },
      { name: 'Trench Coat', icon: 'CoatHanger', tags: ['fashion', 'rain_light', 'business'], estimatedWeight: 1000 },
      { name: 'Overcoat', icon: 'CoatHanger', tags: ['formal', 'winter', 'business'], estimatedWeight: 1300 }, // [28]
      // Undergarments & Sleepwear
      { name: 'Underwear', icon: 'TShirt', essential: true, defaultQuantity: 7, estimatedWeight: 50 }, // [1]
      ...
      { name: 'Tights', icon: 'PersonSimple', tags: ['business', 'formal', 'women', 'cold'], estimatedWeight: 70 },
      { name: 'Stockings', icon: 'PersonSimple', tags: ['business', 'formal', 'women', 'cold'], estimatedWeight: 50 }, // (pair)
      {
      ...
      { name: 'Dressing Gown', icon: 'Bathtub', tags: ['comfort', 'home', 'hotel'], estimatedWeight: 700 },
      { name: 'Loungewear Set', icon: 'Couch', tags: ['comfort', 'home', 'travel'], estimatedWeight: 500 },
      { name: 'Slips (Undergarment)', icon: 'PersonSimple', tags: ['women', 'formal', 'layering'], estimatedWeight: 100 },
      // Swimwear
      {
      ...
      { name: 'Bikini', icon: 'SwimmingPool', tags: ['beach', 'pool', 'women'], estimatedWeight: 150 },
      { name: 'Tankini', icon: 'SwimmingPool', tags: ['beach', 'pool', 'women'], estimatedWeight: 200 },
      { name: 'One-Piece Swimsuit', icon: 'SwimmingPool', tags: ['beach', 'pool', 'women'], estimatedWeight: 200 },
      { name: 'Swim Trunks', icon: 'SwimmingPool', tags: ['beach', 'pool', 'men'], estimatedWeight: 150 },
      {
        name: 'Board Shorts',
        icon: 'SwimmingPool',
      ...
      { name: 'Swim Cover-Up', icon: 'PersonSimple', tags: ['beach', 'pool', 'women', 'unisex'], estimatedWeight: 250 },
      { name: 'Sarong', icon: 'Package', tags: ['beach', 'pool', 'multi_purpose', 'unisex'], estimatedWeight: 200 },
      ...
      { name: 'Sports Skirt', icon: 'TennisBall', tags: ['active', 'women', 'tennis', 'golf'], estimatedWeight: 180 },
      { name: 'Skort', icon: 'TennisBall', tags: ['active', 'women', 'tennis', 'golf'], estimatedWeight: 200 },
      { name: 'Cycling Shorts', icon: 'Bicycle', tags: ['cycling', 'sports'], estimatedWeight: 180 },
      { name: 'Cycling Jersey', icon: 'Bicycle', tags: ['cycling', 'sports'], estimatedWeight: 150 },
      {
      ...
      { name: 'Hiking Shorts', icon: 'PersonSimpleHike', tags: ['outdoor', 'hiking'], estimatedWeight: 220 },
      { name: 'Hiking Pants', icon: 'PersonSimpleHike', tags: ['outdoor', 'hiking'], estimatedWeight: 400 },
      {
        name: 'Climbing Pants',
        icon: 'PersonSimpleHike',
      ...
      { name: 'Fishing Vest', icon: 'FishSimple', tags: ['outdoor', 'fishing', 'utility'], estimatedWeight: 300 },
      { name: 'Wetsuit', icon: 'Waves', tags: ['diving', 'surfing', 'water_sports'], estimatedWeight: 1500 }, // (can vary greatly)
      { name: 'Golf Attire', icon: 'Golf', tags: ['sports', 'golf'], estimatedWeight: 450 }, // (polo + pants/shorts)
      { name: 'Tennis Attire', icon: 'TennisBall', tags: ['sports', 'tennis'], estimatedWeight: 300 }, // (top + skirt/shorts)
      { name: 'Sports Hijab', icon: 'PersonSimple', tags: ['active', 'women', 'modest', 'sports'], estimatedWeight: 100 },
      // Formal & Business Wear
      { name: 'Suit Jacket', icon: 'UserTie', tags: ['business', 'formal', 'event'], estimatedWeight: 800 }, // [1]
      { name: 'Blazer', icon: 'UserTie', tags: ['business', 'formal_casual', 'event'], estimatedWeight: 700 },
      { name: 'Suit Trousers', icon: 'UserTie', tags: ['business', 'formal', 'event'], estimatedWeight: 400 },
      { name: 'Business Skirt', icon: 'UserTie', tags: ['business', 'formal', 'event', 'women'], estimatedWeight: 300 },
      { name: 'Full Suit', icon: 'UserTie', tags: ['business', 'formal', 'event'], estimatedWeight: 1200 }, // [1]
      { name: 'Tuxedo', icon: 'UserTie', tags: ['formal', 'event', 'wedding', 'black_tie'], estimatedWeight: 1300 },
      { name: 'Tie', icon: 'UserTie', tags: ['formal', 'business', 'men'], estimatedWeight: 60 },
      { name: 'Bowtie', icon: 'UserTie', tags: ['formal', 'business', 'men', 'event'], estimatedWeight: 30 },
      { name: 'Cufflinks', icon: 'Diamond', tags: ['business', 'men', 'formal_accessory'], estimatedWeight: 20 }, // (pair)
      { name: 'Pocket Square', icon: 'Diamond', tags: ['business', 'men', 'formal_accessory'], estimatedWeight: 15 },
      // Clothing Accessories
      { name: 'Belt', icon: 'Belt', estimatedWeight: 150 },
      { name: 'Fashion Hat', icon: 'BaseballCap', tags: ['casual', 'accessory'], estimatedWeight: 120 },
      { name: 'Baseball Cap', icon: 'BaseballCap', tags: ['casual', 'accessory', 'sports'], estimatedWeight: 100 },
      { name: 'Wide-Brim Sun Hat', icon: 'Sun', tags: ['beach', 'sun_protection', 'accessory'], estimatedWeight: 150 },
      { name: 'Beanie', icon: 'Beanie', tags: ['winter', 'cold', 'accessory'], estimatedWeight: 80 },
      { name: 'Winter Hat', icon: 'Beanie', tags: ['winter', 'cold', 'accessory'], estimatedWeight: 100 }, // [1]
      { name: 'Fashion Scarf', icon: 'Stool', tags: ['accessory', 'fashion'], estimatedWeight: 150 }, // [1]
      { name: 'Warm Scarf', icon: 'Stool', tags: ['winter', 'cold', 'accessory'], estimatedWeight: 250 }, // [1]
      { name: 'Gloves', icon: 'HandGrabbing', tags: ['winter', 'cold', 'accessory', 'ski'], estimatedWeight: 100 }, // (pair) [1]
      { name: 'Mittens', icon: 'HandGrabbing', tags: ['winter', 'cold', 'accessory', 'ski'], estimatedWeight: 120 }, // (pair)
      {
        name: 'Shawl',
        icon: 'Package',
      ...
      { name: 'Bandana', icon: 'Package', tags: ['accessory', 'multi_purpose', 'fashion'], estimatedWeight: 40 },
      {
        name: 'Headscarf',
        icon: 'Package',
      ...
      { name: 'Earmuffs', icon: 'Ear', tags: ['ski', 'snow', 'cold', 'accessory'], estimatedWeight: 80 },
      { name: 'Ear Warmers', icon: 'Ear', tags: ['ski', 'snow', 'cold', 'accessory'], estimatedWeight: 60 },
      {
        name: 'Neck Gaiter',
        icon: 'MaskHappy',
      ...
      { name: 'Abaya', icon: 'PersonSimple', tags: ['cultural', 'women', 'modest'], estimatedWeight: 600 },
      { name: 'Kaftan', icon: 'PersonSimple', tags: ['beach', 'cultural', 'women', 'loungewear'], estimatedWeight: 400 },
      { name: 'Cultural Sarong', icon: 'Package', tags: ['beach', 'cultural', 'men', 'unisex'], estimatedWeight: 250 },
      { name: 'Lungi', icon: 'Package', tags: ['cultural', 'men', 'unisex'], estimatedWeight: 200 },
      { name: 'Kimono', icon: 'Package', tags: ['loungewear', 'cultural', 'fashion'], estimatedWeight: 500 }, // (can vary greatly)
      { name: 'Sari', icon: 'PersonSimple', tags: ['cultural', 'formal', 'event', 'women'], estimatedWeight: 800 }, // (can vary greatly)
      { name: 'Kurta', icon: 'UserTie', tags: ['cultural', 'formal_casual', 'event'], estimatedWeight: 300 },
      { name: 'Sherwani', icon: 'UserTie', tags: ['cultural', 'formal', 'event', 'wedding'], estimatedWeight: 1200 },
      { name: 'Festival Outfit', icon: 'Ghost', tags: ['festival', 'event', 'party'], estimatedWeight: 500 }, // (highly variable)
      { name: 'Costume', icon: 'Ghost', tags: ['event', 'party', 'halloween'], estimatedWeight: 600 }, // (highly variable)
      { name: 'Work Uniform', icon: 'HardHat', tags: ['work', 'professional'], estimatedWeight: 700 }, // (highly variable)
      { name: 'Academic Gown', icon: 'GraduationCap', tags: ['event', 'education', 'ceremony'], estimatedWeight: 800 },
      { name: 'Academic Regalia', icon: 'GraduationCap', tags: ['event', 'education', 'ceremony'], estimatedWeight: 1000 }, // (gown, hood, cap)
      // Ski & Snow Clothing
      { name: 'Ski Jacket', icon: 'CoatHanger', tags: ['ski', 'snow', 'winter', 'outerwear'], estimatedWeight: 1000 },
      { name: 'Ski Pants', icon: 'Pants', tags: ['ski', 'snow', 'winter', 'outerwear'], estimatedWeight: 800 },
      { name: 'Ski Socks', icon: 'Sock', tags: ['ski', 'snow', 'winter', 'warmth'], estimatedWeight: 100 }, // (pair)
      { name: 'Snow Goggles', icon: 'Goggles', tags: ['ski', 'snow', 'winter', 'eye_protection'], estimatedWeight: 180 },
      // Maternity Clothing
      { name: 'Nursing Bra', icon: 'Baby', tags: ['maternity', 'women', 'baby_care'], estimatedWeight: 120 },
      { name: 'Maternity Tops', icon: 'TShirt', tags: ['pregnant', 'women', 'comfort'], estimatedWeight: 200 },
      { name: 'Maternity Bottoms', icon: 'Pants', tags: ['pregnant', 'women', 'comfort'], estimatedWeight: 400 },
      { name: 'Maternity Dresses', icon: 'PersonSimple', tags: ['pregnant', 'women', 'comfort'], estimatedWeight: 450 },
      { name: 'Belly Band', icon: 'Circle', tags: ['maternity', 'support', 'pregnant'], estimatedWeight: 100 },
      {
  ...
  },
  {
    category: 'Footwear',
    defaultIcon: 'Sneaker',
    items: [ // All footwear weights are per pair
      { name: 'Sneakers', icon: 'Sneaker', essential: true, defaultQuantity: 1, estimatedWeight: 700 },
      { name: 'Walking Shoes', icon: 'Sneaker', essential: true, defaultQuantity: 1, estimatedWeight: 650 },
      { name: 'Running Shoes', icon: 'PersonSimpleRun', tags: ['sports', 'active', 'exercise'], estimatedWeight: 550 },
      {
      ...
      { name: 'Hiking Boots', icon: 'Boot', tags: ['outdoor', 'hiking', 'adventure'], estimatedWeight: 1200 },
      { name: 'Sandals', icon: 'SneakerMove', tags: ['casual', 'warm_weather', 'beach'], estimatedWeight: 400 },
      { name: 'Flip-Flops', icon: 'SneakerMove', tags: ['beach', 'pool', 'casual', 'shower'], estimatedWeight: 250 },
      { name: 'Water Shoes', icon: 'Waves', tags: ['beach', 'water_sports', 'outdoor', 'pool'], estimatedWeight: 350 },
      { name: 'Aqua Socks', icon: 'Waves', tags: ['beach', 'water_sports', 'pool'], estimatedWeight: 300 },
      { name: 'Dress Shoes', icon: 'UserTie', tags: ['formal', 'business', 'event'], estimatedWeight: 800 },
      { name: 'Oxfords', icon: 'UserTie', tags: ['formal', 'business', 'men'], estimatedWeight: 850 },
      { name: 'Loafers', icon: 'UserTie', tags: ['formal_casual', 'business_casual', 'men'], estimatedWeight: 700 },
      { name: 'Heels', icon: 'HighHeel', tags: ['formal', 'women', 'event', 'business'], estimatedWeight: 600 },
      {
        name: 'Ballet Flats',
        icon: 'SneakerMove',
      ...
      { name: 'Fashion Boots', icon: 'Boot', tags: ['casual', 'fall', 'fashion'], estimatedWeight: 1000 },
      { name: 'Winter Boots', icon: 'Boot', tags: ['casual', 'winter', 'cold'], estimatedWeight: 1400 },
      { name: 'Snow Boots', icon: 'Snowflake', tags: ['ski', 'snow', 'winter', 'cold', 'outdoor'], estimatedWeight: 1500 },
      { name: 'Wading Boots', icon: 'FishSimple', tags: ['fishing', 'outdoor', 'water'], estimatedWeight: 1300 },
      { name: 'Equestrian Riding Boots', icon: 'Horse', tags: ['equestrian', 'sports'], estimatedWeight: 1800 },
      {
        name: 'Climbing Shoes',
        icon: 'PersonSimpleHike',
      ...
      { name: 'Dance Shoes', icon: 'MusicNotesSimple', tags: ['sports', 'dance', 'activity'], estimatedWeight: 400 },
      { name: 'Safety Boots', icon: 'HardHat', tags: ['work', 'safety', 'industrial'], estimatedWeight: 1800 },
      { name: 'Steel-Toe Boots', icon: 'HardHat', tags: ['work', 'safety', 'industrial'], estimatedWeight: 2000 },
      {
        name: 'Sports Cleats',
        icon: 'SoccerBall',
      ...
      { name: 'Slippers', icon: 'HouseSimple', tags: ['comfort', 'home', 'hotel'], estimatedWeight: 300 },
      { name: 'House Shoes', icon: 'HouseSimple', tags: ['comfort', 'home', 'hotel'], estimatedWeight: 300 },
      { name: 'Espadrilles', icon: 'SneakerMove', tags: ['summer', 'casual', 'vacation'], estimatedWeight: 500 },
      { name: 'Clogs', icon: 'SneakerMove', tags: ['wellness', 'spa', 'casual', 'work'], estimatedWeight: 600 },
      { name: 'Galoshes', icon: 'CloudRain', tags: ['rain', 'protection', 'footwear_accessory'], estimatedWeight: 700 },
      { name: 'Overshoes', icon: 'CloudRain', tags: ['rain', 'protection', 'footwear_accessory'], estimatedWeight: 400 },
      { name: 'Shoe Insoles', icon: 'Sneaker', tags: ['comfort', 'health', 'footwear_accessory'], estimatedWeight: 100 }, // (pair)
      { name: 'Orthotics', icon: 'Sneaker', tags: ['health', 'footwear_accessory', 'medical'], estimatedWeight: 150 }, // (pair)
      {
      ...
      { name: 'Shoe Horn', icon: 'Toolbox', tags: ['accessory', 'footwear_helper'], estimatedWeight: 80 },
      { name: 'Shoe Polish', icon: 'PaintBrushHousehold', tags: ['maintenance', 'footwear_care'], estimatedWeight: 100 }, // (including container)
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Toothbrush Cover', icon: 'ArchiveBox', tags: ['hygiene', 'travel'], estimatedWeight: 10 },
      { name: 'Toothbrush Travel Case', icon: 'ArchiveBox', tags: ['hygiene', 'travel'], estimatedWeight: 50 },
      { name: 'Dental Floss', icon: 'Minus', essential: true, tags: ['hygiene', 'dental'], estimatedWeight: 25 },
      ...
      { name: 'Mouthwash', icon: 'DropSimple', tags: ['hygiene', 'dental', 'travel_size'], estimatedWeight: 120 }, // (travel size ~100ml)
      { name: 'Deodorant', icon: 'Sparkle', essential: true, estimatedWeight: 75 }, // (stick)
      { name: 'Deodorant Wipes', icon: 'Sparkle', tags: ['hygiene', 'travel', 'refresh'], estimatedWeight: 50 }, // (pack of 10-20)
      { name: 'Bar Soap', icon: 'HandSoap', essential: true, tags: ['hygiene'], estimatedWeight: 100 },
      {
      ...
      { name: 'Face Wash', icon: 'DropSimple', tags: ['skincare', 'hygiene'], estimatedWeight: 120 }, // (travel size ~100ml)
      { name: 'Facial Cleanser', icon: 'DropSimple', tags: ['skincare', 'hygiene'], estimatedWeight: 120 }, // (travel size ~100ml)
      { name: 'Cotton Swabs (Q-tips)', icon: 'DotsThree', tags: ['hygiene', 'beauty_tool'], estimatedWeight: 20 }, // (small travel pack)
      { name: 'Cotton Pads', icon: 'Circle', tags: ['hygiene', 'skincare', 'makeup_tool'], estimatedWeight: 30 }, // (small travel pack)
      {
      ...
      // Skincare
      { name: 'Face Moisturizer', icon: 'DropSimple', essential: true, tags: ['skincare'], estimatedWeight: 75 }, // (travel size ~50ml)
      { name: 'Body Lotion', icon: 'DropSimple', essential: true, tags: ['skincare'], estimatedWeight: 120 }, // (travel size ~100ml)
      { name: 'Toner', icon: 'SprayBottle', tags: ['skincare', 'refresh'], estimatedWeight: 120 }, // (travel size ~100ml)
      { name: 'Facial Mist', icon: 'SprayBottle', tags: ['skincare', 'refresh', 'hydration'], estimatedWeight: 80 }, // (travel size ~50ml)
      { name: 'Face Serum', icon: 'DropSimple', tags: ['skincare', 'treatment'], estimatedWeight: 50 }, // (travel size ~30ml)
      { name: 'Eye Cream', icon: 'Eye', tags: ['skincare', 'treatment'], estimatedWeight: 30 }, // (travel size ~15ml)
      { name: 'Lip Balm', icon: 'DropSimple', essential: true, tags: ['skincare'], estimatedWeight: 15 },
      { name: 'SPF Lip Balm', icon: 'Sun', essential: true, tags: ['skincare', 'sun_protection'], estimatedWeight: 15 },
      { name: 'Hand Cream', icon: 'HandPalm', tags: ['skincare', 'hygiene'], estimatedWeight: 50 }, // (travel size ~30-50ml)
      { name: 'Foot Cream', icon: 'DropSimple', tags: ['skincare', 'comfort', 'pedicure'], estimatedWeight: 75 }, // (travel size)
      { name: 'Foot Balm', icon: 'DropSimple', tags: ['skincare', 'comfort', 'pedicure'], estimatedWeight: 50 }, // (stick)
      {
      ...
      { name: 'Body Scrub', icon: 'DropSimple', tags: ['skincare', 'spa', 'exfoliate'], estimatedWeight: 100 }, // (travel size)
      {
      ...
      { name: 'Foot Powder', icon: 'DropSimple', tags: ['health', 'comfort', 'hygiene'], estimatedWeight: 70 }, // (travel size)
      // Hair Care
      { name: 'Shampoo', icon: 'DropSimple', essential: true, tags: ['hair_care', 'travel_size'], estimatedWeight: 120 }, // (travel size ~100ml)
      {
      ...
      { name: 'Leave-In Conditioner', icon: 'SprayBottle', tags: ['hair_care'], estimatedWeight: 100 }, // (travel size)
      { name: 'Detangler Spray', icon: 'SprayBottle', tags: ['hair_care'], estimatedWeight: 100 }, // (travel size)
      { name: 'Dry Shampoo', icon: 'Wind', tags: ['hair_care', 'travel_hack'], estimatedWeight: 80 }, // (travel size aerosol)
      ...
      { name: 'Hair Ties', icon: 'Paperclip', tags: ['hair_care', 'accessory'], estimatedWeight: 5 }, // (few)
      { name: 'Hair Clips', icon: 'Paperclip', tags: ['hair_care', 'accessory'], estimatedWeight: 10 }, // (few)
      { name: 'Hair Pins', icon: 'Paperclip', tags: ['hair_care', 'accessory'], estimatedWeight: 5 }, // (few bobby pins)
      { name: 'Hair Gel', icon: 'SprayBottle', tags: ['hair_care', 'styling'], estimatedWeight: 100 }, // (travel size tube)
      { name: 'Hair Spray', icon: 'SprayBottle', tags: ['hair_care', 'styling'], estimatedWeight: 80 }, // (travel size aerosol)
      { name: 'Hair Mousse', icon: 'SprayBottle', tags: ['hair_care', 'styling'], estimatedWeight: 70 }, // (travel size aerosol)
      { name: 'Hair Wax', icon: 'DropSimple', tags: ['hair_care', 'styling'], estimatedWeight: 50 }, // (small tin)
      { name: 'Hair Serum', icon: 'DropSimple', tags: ['hair_care', 'styling', 'treatment'], estimatedWeight: 40 }, // (travel size bottle)
      { name: 'Hair Oil', icon: 'DropSimple', tags: ['hair_care', 'styling', 'treatment'], estimatedWeight: 40 }, // (travel size bottle)
      {
      ...
      { name: 'Travel Hair Dryer', icon: 'HairDryer', tags: ['styling_tool', 'travel_size'], estimatedWeight: 350 },
      {
      ...
      { name: 'Aftershave', icon: 'DropSimple', tags: ['skincare', 'grooming'], estimatedWeight: 70 }, // (travel size bottle)
      { name: 'Aftershave Balm', icon: 'DropSimple', tags: ['skincare', 'grooming'], estimatedWeight: 50 }, // (travel size tube)
      { name: 'Beard Oil', icon: 'User', tags: ['men', 'grooming', 'beard_care'], estimatedWeight: 40 }, // (small bottle)
      { name: 'Beard Balm', icon: 'User', tags: ['men', 'grooming', 'beard_care'], estimatedWeight: 50 }, // (small tin)
      { name: 'Beard Comb', icon: 'Toolbox', tags: ['men', 'grooming', 'beard_care'], estimatedWeight: 15 },
      { name: 'Beard Brush', icon: 'Toolbox', tags: ['men', 'grooming', 'beard_care'], estimatedWeight: 50 },
      { name: 'Electric Shaver', icon: 'Plugs', tags: ['grooming', 'electric_tool'], estimatedWeight: 200 }, // (travel size)
      { name: 'Electric Shaver Charger', icon: 'Plugs', tags: ['grooming', 'electric_tool'], estimatedWeight: 100 },
      // Makeup & Beauty
      { name: 'Foundation', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_base'], estimatedWeight: 50 }, // (bottle/tube)
      { name: 'Concealer', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_base'], estimatedWeight: 20 }, // (tube/stick)
      {
      ...
      { name: 'Mascara', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_color'], estimatedWeight: 25 },
      { name: 'Eyeliner', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_color'], estimatedWeight: 10 }, // (pencil/liquid)
      { name: 'Lipstick', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_color'], estimatedWeight: 20 },
      { name: 'Lip Gloss', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_color'], estimatedWeight: 20 },
      { name: 'Blush', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_color'], estimatedWeight: 30 }, // (compact)
      { name: 'Bronzer', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_color'], estimatedWeight: 40 }, // (compact)
      { name: 'Highlighter', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'makeup_color'], estimatedWeight: 30 }, // (compact/stick)
      { name: 'Makeup Primer', icon: 'PaintBrushBroad', tags: ['makeup', 'women', 'beauty_prep'], estimatedWeight: 40 }, // (travel size tube)
      {
      ...
      { name: 'Makeup Brushes', icon: 'PaintBrushBroad', tags: ['makeup', 'beauty_tool'], estimatedWeight: 100 }, // (small travel set)
      { name: 'Makeup Sponges', icon: 'PaintBrushBroad', tags: ['makeup', 'beauty_tool'], estimatedWeight: 10 }, // (one sponge)
      { name: 'Blotting Papers', icon: 'FileText', tags: ['makeup', 'oil_control', 'beauty_tool'], estimatedWeight: 10 }, // (pack)
      {
      ...
      { name: 'Wax Strips', icon: 'DropSimple', tags: ['women', 'grooming', 'beauty_treatment'], estimatedWeight: 50 }, // (small box for face/body)
      { name: 'Nail Polish', icon: 'PaintBrushBroad', tags: ['women', 'beauty', 'manicure'], estimatedWeight: 50 }, // (one bottle)
      { name: 'Nail Polish Remover', icon: 'Eraser', tags: ['women', 'beauty', 'manicure'], estimatedWeight: 80 }, // (travel size bottle or pads)
      { name: 'Perfume', icon: 'DropSimple', tags: ['beauty', 'fragrance', 'travel_size'], estimatedWeight: 50 }, // (travel spray/rollerball ~10-30ml)
      { name: 'Cologne', icon: 'DropSimple', tags: ['beauty', 'fragrance', 'travel_size'], estimatedWeight: 50 }, // (travel spray ~10-30ml)
      {
        name: 'Solid Perfume',
        icon: 'DropSimple',
      ...
      { name: 'Body Glitter', icon: 'Sparkle', tags: ['festival', 'party', 'beauty_enhancement'], estimatedWeight: 30 }, // (small pot/tube)
      { name: 'Face Gems', icon: 'Sparkle', tags: ['festival', 'party', 'beauty_enhancement'], estimatedWeight: 10 }, // (sheet)
      { name: 'Compact Mirror', icon: 'Circle', tags: ['beauty_tool', 'travel_accessory'], estimatedWeight: 50 },
      // Manicure & Pedicure
      { name: 'Nail Clippers', icon: 'Scissors', tags: ['grooming', 'manicure', 'pedicure'], estimatedWeight: 30 },
      { name: 'Nail File', icon: 'Toolbox', tags: ['grooming', 'manicure', 'pedicure'], estimatedWeight: 10 },
      { name: 'Tweezers', icon: 'Toolbox', tags: ['grooming', 'beauty_tool', 'first_aid'], estimatedWeight: 15 },
      { name: 'Cuticle Oil', icon: 'DropSimple', tags: ['nails', 'manicure', 'skincare'], estimatedWeight: 20 }, // (small bottle/pen)
      { name: 'Cuticle Cream', icon: 'DropSimple', tags: ['nails', 'manicure', 'skincare'], estimatedWeight: 25 }, // (small tube/pot)
      // Sun & Bug Protection
      {
        name: 'Face Sunscreen',
        icon: 'Sun',
      ...
      { name: 'Aloe Vera Gel', icon: 'DropSimple', tags: ['sun_care', 'skincare', 'soothing'], estimatedWeight: 100 }, // (travel size)
      { name: 'After-Sun Lotion', icon: 'DropSimple', tags: ['sun_care', 'skincare', 'soothing'], estimatedWeight: 100 }, // (travel size)
      {
      ...
      { name: 'Contact Lenses', icon: 'Eye', tags: ['vision', 'health'], essential: true, estimatedWeight: 10 }, // (pair in solution or few disposables)
      {
      ...
      { name: 'Glasses Case', icon: 'Eyeglasses', tags: ['vision', 'accessory'], estimatedWeight: 100 },
      {
      ...
      { name: 'Bath Salts', icon: 'Bathtub', tags: ['relaxation', 'spa', 'bath'], estimatedWeight: 100 }, // (single use pouch)
      { name: 'Bath Bombs', icon: 'Bathtub', tags: ['relaxation', 'spa', 'bath'], estimatedWeight: 150 }, // (one bomb)
      {
      ...
      { name: 'Portable Bidet', icon: 'DropSimple', tags: ['hygiene', 'travel_accessory'], estimatedWeight: 100 }, // (empty)
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Car Phone Charger', icon: 'CarSimple', tags: ['roadtrip', 'tech_accessory'], estimatedWeight: 50 },
      { name: 'Wireless Charger Pad', icon: 'Plugs', tags: ['phone_accessory', 'tech'], estimatedWeight: 100 },
      { name: 'Laptop', icon: 'Laptop', tags: ['work', 'entertainment'], estimatedWeight: 1500 }, // (13-15 inch ultrabook)
      { name: 'Laptop Charger', icon: 'Plugs', tags: ['work', 'tech_accessory'], estimatedWeight: 300 },
      { name: 'Tablet', icon: 'DeviceTablet', tags: ['entertainment', 'reading'], estimatedWeight: 450 }, // (e.g. iPad Air)
      ...
      { name: 'Power Bank', icon: 'BatteryCharging', essential: true, tags: ['portable_charger'], estimatedWeight: 250 }, // (10000mAh)
      { name: 'Solar Power Bank', icon: 'Sun', tags: ['outdoor', 'emergency', 'tech'], estimatedWeight: 350 }, // (10000mAh with panel)
      {
      ...
      { name: 'Camera Lenses', icon: 'Camera', tags: ['photography_accessory'], estimatedWeight: 400 }, // (average zoom lens)
      { name: 'Camera Charger', icon: 'Plugs', tags: ['photography_accessory'], estimatedWeight: 100 },
      { name: 'Camera Batteries (Spare)', icon: 'BatteryFull', tags: ['photography_accessory'], estimatedWeight: 80 }, // (per battery)
      { name: 'Memory Cards', icon: 'FloppyDisk', tags: ['photography_accessory', 'storage'], estimatedWeight: 5 }, // (per card)
      { name: 'Memory Card Reader', icon: 'FloppyDiskBack', tags: ['tech_accessory', 'storage'], estimatedWeight: 30 },
      {
      ...
      { name: 'Action Camera Mounts', icon: 'Toolbox', tags: ['action_camera_accessory'], estimatedWeight: 100 }, // (assortment)
      { name: 'Action Camera Batteries', icon: 'BatteryFull', tags: ['action_camera_accessory'], estimatedWeight: 30 }, // (per battery)
      { name: 'Drone', icon: 'Drone', tags: ['photography', 'video', 'hobby'], estimatedWeight: 800 }, // (e.g. DJI Mavic series)
      { name: 'Drone Controller', icon: 'GameController', tags: ['drone_accessory'], estimatedWeight: 300 },
      { name: 'Drone Batteries', icon: 'BatteryFull', tags: ['drone_accessory'], estimatedWeight: 250 }, // (per battery)
      { name: 'Drone Charger', icon: 'Plugs', tags: ['drone_accessory'], estimatedWeight: 150 },
      { name: 'Tripod', icon: 'CameraRotate', tags: ['photography_accessory', 'video_accessory'], estimatedWeight: 1200 }, // (travel tripod)
      {
        name: 'Selfie Stick',
      ...
      { name: 'Gimbal', icon: 'CameraRotate', tags: ['video_accessory', 'stabilizer'], estimatedWeight: 400 }, // (phone gimbal)
      {
      ...
      { name: 'E-Reader (Kindle)', icon: 'BookOpenText', tags: ['reading', 'entertainment'], estimatedWeight: 200 },
      { name: 'E-Reader Charger', icon: 'Plugs', tags: ['tech_accessory'], estimatedWeight: 40 }, // (cable)
      { name: 'Smartwatch', icon: 'Watch', tags: ['wearable_tech', 'fitness'], estimatedWeight: 50 },
      { name: 'Fitness Tracker', icon: 'Watch', tags: ['wearable_tech', 'health'], estimatedWeight: 30 },
      { name: 'Smartwatch/Fitness Tracker Charger', icon: 'Plugs', tags: ['tech_accessory'], estimatedWeight: 20 },
      { name: 'USB-C Cable', icon: 'Usb', tags: ['charging_cable', 'data_transfer'], estimatedWeight: 30 },
      {
      ...
      { name: 'Micro USB Cable', icon: 'Usb', tags: ['charging_cable', 'data_transfer'], estimatedWeight: 30 },
      { name: 'Portable WiFi Hotspot (MiFi)', icon: 'WifiHigh', tags: ['internet', 'travel_tech'], estimatedWeight: 150 },
      {
      ...
      { name: 'Local SIM Card', icon: 'SimCard', tags: ['communication', 'travel_tech'], estimatedWeight: 2 },
      { name: 'SIM Eject Tool', icon: 'Key', tags: ['phone_accessory', 'travel_tool'], estimatedWeight: 1 },
      { name: 'Handheld GPS Device', icon: 'Gps', tags: ['navigation', 'outdoor', 'hiking'], estimatedWeight: 200 },
      { name: 'Car GPS Navigator', icon: 'CarSimple', tags: ['navigation', 'roadtrip'], estimatedWeight: 250 },
      { name: 'Portable Bluetooth Speaker', icon: 'SpeakerHigh', tags: ['audio', 'entertainment'], estimatedWeight: 300 }, // (small/medium)
      { name: 'Travel Extension Cord', icon: 'Plugs', tags: ['power_access', 'tech_accessory'], estimatedWeight: 200 },
      { name: 'Travel Power Strip', icon: 'Plugs', tags: ['power_access', 'tech_accessory'], estimatedWeight: 250 },
      { name: 'USB Flash Drive', icon: 'FloppyDisk', tags: ['storage', 'data_transfer'], estimatedWeight: 10 },
      { name: 'Portable SSD', icon: 'HardDrive', tags: ['storage', 'data_transfer', 'backup'], estimatedWeight: 100 }, // (e.g. Samsung T7)
      { name: 'External Hard Drive', icon: 'HardDrives', tags: ['storage', 'backup'], estimatedWeight: 250 }, // (2.5 inch portable)
      {
      ...
      { name: 'Gaming Console Charger', icon: 'Plugs', tags: ['tech_accessory', 'gaming'], estimatedWeight: 100 },
      { name: 'Digital Luggage Scale', icon: 'Scales', tags: ['travel_tool', 'luggage_check'], estimatedWeight: 150 },
    ],
  },
  {
    category: 'Documents & Money',
    defaultIcon: 'IdentificationCard',
    items: [ // Weights are generally low and for the physical item itself
      ...
      { name: 'Travel Tickets (Flight, Train, Bus)', icon: 'AirplaneTicket', essential: true, estimatedWeight: 5 }, // (per printed ticket)
      { name: 'Boarding Passes (Digital/Printed)', icon: 'Ticket', essential: true, estimatedWeight: 5 }, // (per printed pass)
      {
      ...
      { name: 'Credit Cards', icon: 'CreditCard', essential: true, tags: ['payment', 'finance'], estimatedWeight: 5 }, // (per card)
      { name: 'Debit Cards', icon: 'CreditCard', essential: true, tags: ['payment', 'finance'], estimatedWeight: 5 }, // (per card)
      { name: 'Local Currency Cash', icon: 'Money', essential: true, tags: ['payment', 'finance'], estimatedWeight: 20 }, // (small bundle of notes)
      {
      ...
      { name: 'Important Addresses List', icon: 'MapPin', tags: ['navigation', 'important_info'], estimatedWeight: 5 }, // Printed paper
      { name: 'Travel Itinerary', icon: 'CalendarDots', tags: ['planning', 'organization'], estimatedWeight: 10 }, // Printed papers
      {
      ...
      { name: 'Copies of Visas', icon: 'Copy', essential: true, tags: ['backup', 'entry_permit'], estimatedWeight: 5 }, // (per copy)
      { name: 'Copies of Other Important Documents', icon: 'Copy', tags: ['backup', 'safety'], estimatedWeight: 5 }, // (per copy)
      {
      ...
      { name: 'Student ID Card', icon: 'Student', tags: ['identification', 'discounts'], estimatedWeight: 5 },
      {
        name: 'ISIC Card',
        icon: 'Student',
      ...
      { name: 'Senior Discount Card', icon: 'User', tags: ['identification', 'discounts'], estimatedWeight: 5 },
      { name: 'Frequent Flyer Cards', icon: 'Airplane', tags: ['loyalty_program', 'travel_perks'], estimatedWeight: 5 }, // (per card)
      { name: 'Hotel Loyalty Cards', icon: 'Bed', tags: ['loyalty_program', 'travel_perks'], estimatedWeight: 5 }, // (per card)
      { name: 'Business Cards', icon: 'AddressBook', tags: ['work_travel', 'networking'], estimatedWeight: 1 }, // (per card)
      { name: 'Membership Cards (Museums, etc.)', icon: 'Ticket', tags: ['leisure', 'discounts'], estimatedWeight: 5 }, // (per card)
      { name: 'Gift Cards', icon: 'Gift', tags: ['payment', 'spending'], estimatedWeight: 5 }, // (per card)
      { name: 'Vouchers', icon: 'Ticket', tags: ['payment', 'discounts', 'spending'], estimatedWeight: 2 }, // (paper voucher)
      {
      ...
      { name: 'Money Belt', icon: 'Wallet', tags: ['security', 'travel_accessory', 'finance'], estimatedWeight: 80 }, // (empty)
      {
  ...
  },
  {
    ...
    items: [ // Weights include typical packaging for travel
      ...
      { name: 'Pain Relievers (Ibuprofen/Paracetamol)', icon: 'Pill', essential: true, estimatedWeight: 30 }, // (blister pack/small bottle)
      { name: 'Fever Reducers', icon: 'ThermometerSimple', tags: ['medical', 'cold_flu'], estimatedWeight: 30 }, // (same as pain relievers)
      {
      ...
      { name: 'Antacids', icon: 'Pill', tags: ['digestive_health', 'stomach_relief'], estimatedWeight: 40 }, // (roll of tablets/small bottle)
      {
      ...
      { name: 'Laxative Medication', icon: 'Pill', tags: ['digestive_health'], estimatedWeight: 20 }, // (blister pack)
      { name: 'Cold and Flu Medicine', icon: 'Pill', tags: ['illness_relief', 'cold_flu'], estimatedWeight: 30 }, // (blister pack/sachets)
      { name: 'Throat Lozenges', icon: 'Pill', tags: ['sore_throat_relief', 'cold_flu'], estimatedWeight: 50 }, // (pack/small bag)
      {
      ...
      { name: 'Bandages (Various Sizes)', icon: 'Bandaids', tags: ['first_aid', 'wound_care'], estimatedWeight: 30 }, // (box of assorted)
      {
      ...
      { name: 'Gauze Pads', icon: 'Bandaids', tags: ['first_aid', 'wound_care'], estimatedWeight: 20 }, // (few sterile pads)
      { name: 'Medical Tape', icon: 'Bandaids', tags: ['first_aid', 'wound_care'], estimatedWeight: 25 }, // (small roll)
      {
      ...
      { name: 'Lubricating Eye Drops', icon: 'Eye', tags: ['eye_care', 'dry_eyes', 'comfort'], estimatedWeight: 20 }, // (small bottle/vials)
      { name: 'Antihistamine Eye Drops', icon: 'Eye', tags: ['eye_care', 'allergy_relief'], estimatedWeight: 20 }, // (small bottle)
      {
      ...
      { name: 'Vitamins', icon: 'Pill', tags: ['health_supplement', 'daily_routine'], estimatedWeight: 50 }, // (small travel bottle)
      { name: 'Supplements', icon: 'Pill', tags: ['health_supplement', 'daily_routine'], estimatedWeight: 50 }, // (small travel bottle)
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Sunglasses Case', icon: 'ArchiveBox', tags: ['accessory_protection'], estimatedWeight: 100 }, // (hard case)
      { name: 'Watch', icon: 'Watch', tags: ['timekeeping', 'fashion_accessory'], estimatedWeight: 80 }, // (standard, non-smart)
      { name: 'Jewelry', icon: 'Diamond', tags: ['fashion_accessory', 'personal_items'], estimatedWeight: 50 }, // (a few small pieces)
      { name: 'Jewelry Roll', icon: 'Package', tags: ['travel_organization', 'accessory_storage'], estimatedWeight: 150 }, // (empty)
      {
      ...
      { name: 'Book', icon: 'BookOpenText', tags: ['entertainment', 'relaxation', 'reading'], estimatedWeight: 300 }, // (paperback)
      { name: 'Magazine', icon: 'Article', tags: ['entertainment', 'relaxation', 'reading'], estimatedWeight: 150 },
      {
      ...
      { name: 'Travel Clothes Pegs', icon: 'PushPinSimple', tags: ['laundry', 'travel_hack'], estimatedWeight: 30 }, // (set of few)
      {
      ...
      { name: 'Notepad', icon: 'NoteBlank', tags: ['writing', 'notes', 'journaling', 'planning'], estimatedWeight: 100 }, // (small)
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Backpack', icon: 'Backpack', tags: ['main_luggage', 'carry_on', 'travel_gear'], estimatedWeight: 800 }, // Empty, standard 20-30L
      {
      ...
      { name: 'Lighter', icon: 'FireSimple', tags: ['utility', 'camping', 'emergency_kit'], estimatedWeight: 20 }, // Standard Bic style
      {
      ...
      { name: 'Travel Alarm Clock', icon: 'Alarm', tags: ['timekeeping', 'wake_up_call'], estimatedWeight: 70 }, // Small digital
      {
  ...
  },
  {
    category: 'Baby & Kids',
    defaultIcon: 'Baby',
    items: [ // Weights are for single items or typical small packs
      { name: 'Diapers', icon: 'Baby', essential: true, tags: ['baby_care', 'hygiene'], estimatedWeight: 40 }, // (per diaper)
      {
      ...
      { name: 'Baby Food Pouches', icon: 'Cookie', tags: ['baby_feeding', 'toddler_snacks'], estimatedWeight: 100 }, // (per pouch)
      { name: 'Baby Food Jars', icon: 'Cookie', tags: ['baby_feeding'], estimatedWeight: 150 }, // (per small jar, including contents)
      { name: 'Baby Formula', icon: 'DropSimple', tags: ['baby_feeding', 'infant_nutrition'], estimatedWeight: 400 }, // (small can/pouch of powder)
      { name: 'Baby Bottles', icon: 'DropSimple', tags: ['baby_feeding', 'infant_care'], estimatedWeight: 80 }, // (empty, standard size)
      { name: 'Sippy Cups', icon: 'DropSimple', tags: ['toddler_feeding', 'kids_drinks'], estimatedWeight: 100 }, // (empty)
      {
      ...
      { name: 'Baby Sling', icon: 'Backpack', tags: ['baby_transport', 'newborn_care', 'bonding'], estimatedWeight: 400 },
      { name: 'Pacifiers', icon: 'Baby', tags: ['baby_soothing', 'infant_comfort'], estimatedWeight: 10 }, // (per pacifier)
      { name: 'Teethers', icon: 'Baby', tags: ['baby_comfort', 'teething_relief'], estimatedWeight: 50 }, // (one teether)
      {
      ...
      { name: 'Baby Nail Clippers', icon: 'Scissors', tags: ['baby_grooming', 'infant_care'], estimatedWeight: 20 },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Tent', icon: 'Tent', tags: ['camping_gear', 'shelter', 'outdoor_sleeping'], estimatedWeight: 2000 }, // (2-person backpacking tent)
      { name: 'Sleeping Bag', icon: 'Bed', tags: ['camping_gear', 'outdoor_sleeping', 'warmth'], estimatedWeight: 1200 }, // (3-season synthetic/down)
      {
      ...
      { name: 'Belay Device', icon: 'Toolbox', tags: ['climbing_gear', 'safety_equipment'], estimatedWeight: 80 }, // (e.g. ATC)
      {
      ...
      { name: 'Bike Helmet', icon: 'Bicycle', tags: ['cycling_safety', 'head_protection'], estimatedWeight: 300 },
      {
      ...
      { name: 'Bike Lock', icon: 'Lock', tags: ['cycling_security', 'bike_theft_prevention'], estimatedWeight: 800 }, // (U-lock or heavy chain)
      {
        name: 'Snorkel Mask',
        icon: 'SwimmingPool',
      ...
      { name: 'Surfboard Wax', icon: 'DropSimple', tags: ['surfing_gear', 'board_grip'], estimatedWeight: 80 }, // (one bar)
      {
      ...
      { name: 'Golf Clubs (Travel Set)', icon: 'Golf', tags: ['sports_equipment', 'golf_travel'], estimatedWeight: 4000 }, // (Half set in light bag)
      { name: 'Tennis Racquet', icon: 'TennisBall', tags: ['sports_equipment', 'tennis_gear'], estimatedWeight: 300 }, // (unstrung, without bag)
    ],
  },
];
