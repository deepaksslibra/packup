  ...
  return (
    <div className="space-y-6 md:space-y-8">
      {Object.entries(itemsByCategory).map(([category, items]) => (
        ...
        >
          <div
            className="flex items-center justify-between p-3 md:p-4 border-b relative cursor-pointer"
          ...
          >
            ...
            <div
              ...
              onClick={(e) => e.stopPropagation()} // Prevent collapse toggle when clicking actions
            >
              <button
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          handleOpenRemoveOptionalItemsDialog(category);
                        }}
                      >
